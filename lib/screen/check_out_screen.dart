                ...
                children: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {Clipboard.setData(new ClipboardData(text: "20004078850")).then((_){
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("AYA Account နံပါတ် 2000 407 8850 ကို Copy ကူး လိုက်ပါပြီ")));
                    });},
                    child: const Text('2000 407 8850'),
                  ),
                ],
              ),
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    onPressed: () {Clipboard.setData(new ClipboardData(text: "0078600500032204")).then((_){
                      ScaffoldMessenger.of(context).showSnackBar(SnackBar(content: Text("CB Bank Account နံပါတ် 0078600500032204 ကို Copy ကူး လိုက်ပါပြီ")));
                    });},
